...
$inputFileName = "c:/liturgia/lectures_semaine_temporal.xlsx";
...
foreach ($sheetDataTemporal as $line) {
	...
	$ps1=$line['C'];
	$lec2=$line[];
    $lecurestemporal[$id]['lec1']=$line['B'];
	$lecurestemporal[$id]['pr1']=$line['C'];
	$lecurestemporal[$id]['lec2']=$line['D'];
	$lecurestemporal[$id]['pr2']=$line['E'];
	$lecurestemporal[$id]['EV']=$line['F'];
