...
$objPHPExcel->getProperties()->setTitle("PRECES");
$objPHPExcel->getProperties()->setSubject("PRECES");
$objPHPExcel->getProperties()->setDescription("PRECES - generated using PHP classes.");
$i=1;
// Selectiond e toutes les références PRECES
chdir ( "societaslaudis/wp-content/plugins/liturgia/LH/TXT/" );
foreach (glob("PRECES*.xml") as $filename) {
...
$objPHPExcel->getActiveSheet()->setTitle('PRECES');
...
chdir ( "../../../../../../" );
$objWriter->save('corrections_en_cours/PRECES.xlsx');
