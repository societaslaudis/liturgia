<?php
/*
Adaptation en php du fameux et excellent scripte Astro-MoonPhase de Brett Hamilton �crit en Perl.
http://search.cpan.org/~brett/Astro-MoonPhase-0.60/

Ce Scripte vous permettra de conna�tre, � une date donn�e, l'illumination de la Lune, son age, 
sa distance en km par rapport � la Terre, son angle en degr�s, sa distance par rapport au soleil, 
...
//Pour le 11 Avril 2009 � 00h00
/*
list($MoonPhase, $MoonAge, $MoonDist, $MoonAng, $SunDist, $SunAng, $mpfrac) = Moon::phase(2009, 04, 11, 00, 00, 01);
echo "La Lune est �clair�e � ".number_format($MoonPhase*100, 2, ',', '')."%"."<br>";
echo "Son age est de ".number_format($MoonAge, 0, ',', '')." jours"."<br>";
echo "Et elle se situe � une distance de ".number_format($MoonDist, 0, ',', '')." km par rapport � la Terre."."<br>";
*/
?> 
