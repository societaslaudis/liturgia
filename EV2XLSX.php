...
$objPHPExcel->getProperties()->setTitle("EV");
$objPHPExcel->getProperties()->setSubject("EV");
$objPHPExcel->getProperties()->setDescription("EV - generated using PHP classes.");
$i=1;
// Selectiond e toutes les références EV
...
chdir ( "../../../../../../" );
$objWriter->save('corrections_en_cours/EV.xlsx');
